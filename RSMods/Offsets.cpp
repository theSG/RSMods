...
namespace Offsets {
	...
	// Wwise Logging
	uintptr_t ptr_Wwise_Log_PostEventHook = 0x0ec5226; // 0x01f5b2d6 not tested
	uintptr_t ptr_Wwise_Log_PostEventHookJmpBck = 0x0ec5226 + 5;
	uintptr_t ptr_Wwise_Log_SetRTPCValueHook = 0x0ec2d7c; // 0x01f58a9d todo: rewrite wwise hijack without asm hook
	uintptr_t ptr_Wwise_Log_SetRTPCValueHookJmpBck = 0x0ec2d7c + 5;
